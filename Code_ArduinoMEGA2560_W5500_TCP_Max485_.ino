...
void loop() {
  ...
  // (v1.2.0 từng thêm điều kiện !anyClientPending() để nhường ưu tiên cho
  // lệnh TCP, nhưng gây mất hẳn logic mirror công tắc vật lý — đã rollback
  // ở v1.4.0, xem CHANGELOG.)
